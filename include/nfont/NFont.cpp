...
NFont::NFont(SDL_Renderer* renderer, TTF_Font* ttf)
{
    init();
    load(renderer, ttf, FC_GetDefaultColor(font));
}
NFont::NFont(SDL_Renderer* renderer, TTF_Font* ttf, const NFont::Color& color)
{
    init();
    load(renderer, ttf, color);
}
NFont::NFont(SDL_Renderer* renderer, const char* filename_ttf, Uint32 pointSize)
{
    init();
    load(renderer, filename_ttf, pointSize);
}
NFont::NFont(SDL_Renderer* renderer, const char* filename_ttf, Uint32 pointSize, const NFont::Color& color, int style)
{
    init();
    load(renderer, filename_ttf, pointSize, color, style);
}
NFont::NFont(SDL_Renderer* renderer, SDL_RWops* file_rwops_ttf, Uint8 own_rwops, Uint32 pointSize, const NFont::Color& color, int style)
{
    init();
...
#else
bool NFont::load(SDL_Renderer* renderer, TTF_Font* ttf)
#endif
{
    #ifdef NFONT_USE_SDL_GPU
...
#else
bool NFont::load(SDL_Renderer* renderer, TTF_Font* ttf, const NFont::Color& color)
#endif
{
    if(ttf == NULL)
        return false;
...
#else
bool NFont::load(SDL_Renderer* renderer, const char* filename_ttf, Uint32 pointSize)
#endif
{
    #ifdef NFONT_USE_SDL_GPU
...
#else
bool NFont::load(SDL_Renderer* renderer, const char* filename_ttf, Uint32 pointSize, const NFont::Color& color, int style)
#endif
{
    FC_ClearFont(font);
    #ifdef NFONT_USE_SDL_GPU
...
#else
bool NFont::load(SDL_Renderer* renderer, SDL_RWops* file_rwops_ttf, Uint8 own_rwops, Uint32 pointSize, const NFont::Color& color, int style)
#endif
{
    FC_ClearFont(font);
    #ifdef NFONT_USE_SDL_GPU
...
NFont::Rectf NFont::draw(SDL_Renderer* dest, float x, float y, const char* formatted_text, ...)
{
...
NFont::Rectf NFont::drawBox(SDL_Renderer* dest, const Rectf& box, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
...
NFont::Rectf NFont::drawBox(SDL_Renderer* dest, const Rectf& box, AlignEnum align, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(box.x, box.y, 0, 0);
...
NFont::Rectf NFont::drawBox(SDL_Renderer* dest, const Rectf& box, const Scale& scale, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(box.x, box.y, 0, 0);
...
NFont::Rectf NFont::drawBox(SDL_Renderer* dest, const Rectf& box, const Color& color, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(box.x, box.y, 0, 0);
...
NFont::Rectf NFont::drawBox(SDL_Renderer* dest, const Rectf& box, const Effect& effect, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(box.x, box.y, 0, 0);
...
NFont::Rectf NFont::drawColumn(SDL_Renderer* dest, float x, float y, Uint16 width, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::drawColumn(SDL_Renderer* dest, float x, float y, Uint16 width, AlignEnum align, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::drawColumn(SDL_Renderer* dest, float x, float y, Uint16 width, const Scale& scale, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::drawColumn(SDL_Renderer* dest, float x, float y, Uint16 width, const Color& color, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::drawColumn(SDL_Renderer* dest, float x, float y, Uint16 width, const Effect& effect, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::draw(SDL_Renderer* dest, float x, float y, const Scale& scale, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::draw(SDL_Renderer* dest, float x, float y, AlignEnum align, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::draw(SDL_Renderer* dest, float x, float y, const Color& color, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
...
NFont::Rectf NFont::draw(SDL_Renderer* dest, float x, float y, const Effect& effect, const char* formatted_text, ...)
{
    if(formatted_text == NULL)
        return Rectf(x, y, 0, 0);
